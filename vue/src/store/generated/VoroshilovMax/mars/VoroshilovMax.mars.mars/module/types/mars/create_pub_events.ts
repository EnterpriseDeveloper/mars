...
const baseCreatePubEvents: object = { id: 0, pubId: '', question: '', answers: '', premAmount: '', startTime: '', endTime: '', expertAmount: '', creator: '' }
...
export const CreatePubEvents = {
  ...
  decode(input: Reader | Uint8Array, length?: number): CreatePubEvents {
    ...
    const message = { ...baseCreatePubEvents } as CreatePubEvents
